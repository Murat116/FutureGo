...
class MyModel {
    ...
    static var model = [
        ...
        MyModel(title: "Southwestern Enregy",upString: "-3,69%", price: "4,94 $", graphic: UIImage(named: "img8")),
        MyModel(title: "NOKIA",upString: "11%", price: "5,6 $", graphic: UIImage(named: "img9")),
        MyModel(title: "TSM",upString: "2,46%", price: "161,88 $", graphic: UIImage(named: "img10")),
        MyModel(title: "TAL",upString: "-87,87%", price: "5.03 $", graphic: UIImage(named: "img11")),
        MyModel(title: "Газпром",upString: "-25,38%", price: "326Р", graphic: UIImage(named: "img12")),
        MyModel(title: "EUR",upString: "-5,04%", price: "85,5 R ", graphic: UIImage(named: "img13")),
        MyModel(title: "SNAP INC",upString: "-15,87%", price: "49,76", graphic: UIImage(named: "img14")),
        MyModel(title: "Microsoft",upString: "30,97%", price: "329,85", graphic: UIImage(named: "img15")),
        MyModel(title: "Apple",upString: "23,57%", price: "157,15", graphic: UIImage(named: "img16")),
        MyModel(title: "Hugo Boss", upString: "14,29%",price: "52,2 E", graphic: UIImage(named: "img17")),
        MyModel(title: "Yandex",upString: "9,79%", price: "5 387 P", graphic: UIImage(named: "img18")),
    ]
}
